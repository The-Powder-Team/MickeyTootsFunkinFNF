...
function onUpdatePost(elapsed)
    ...
    local BeforeScore = 'Score: '..score..' | Misses: '..misses..' | Combo: '..hits..' | Rating: '..ratingName..' | NPS: '..Nps
    local FinalScore = 'Score: '..score..' | Misses: '..misses..' | Combo: '..hits..'| Rating: '..ratingName..' ('..ratingFullAsStr..'%) - '..ratingFC..' | NPS: '..Nps
