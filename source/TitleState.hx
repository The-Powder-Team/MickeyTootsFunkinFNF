...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Mickey Toots Funkin' Demo", 12);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 6:
					createCoolText(['Made by', 'CharlesCatYT'], -40);
				case 8:
					addMoreText('and some homies', -40);
					//ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
