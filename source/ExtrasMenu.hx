...
class ExtrasMenu extends MusicBeatState
{
	...
	var controlsStrings:Array<String> = ['CREDITS', 'YOUTUBE', 'DISCORD', 'LATENCY TEST', 'CHANGELOG', #if MODS_ALLOWED 'MODS', 'EDITORS' #end];
	...
	override function update(elapsed:Float)
		...
		if (controls.ACCEPT && canSelect)
			...
			switch(curSelected) {
				...
				case 1:
				FlxG.openURL("https://www.youtube.com/channel/UCF8dP9VIpVIMyXOikoL0xTQ/");
				case 2:
				FlxG.openURL("https://discord.gg/NAMDHhsZUR");
				case 3:
